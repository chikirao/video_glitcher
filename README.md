...
Пошаговая инструкция лежит здесь:

[PUBLISH_TO_GITHUB.md](./PUBLISH_TO_GITHUB.md)

Для этого проекта лучший вариант такой:

- Репозиторий на GitHub для исходников.
- GitHub Pages для публичной ссылки, чтобы люди открывали проект прямо в браузере.
- GitHub Release, если хочешь выкладывать версии вроде `v1.0.0`.
